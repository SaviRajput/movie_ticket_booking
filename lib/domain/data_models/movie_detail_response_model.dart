...
MovieDetailResponseModel movieDetailResponseModelFromJson(String str) =>
    MovieDetailResponseModel.fromJson(json.decode(str));

String movieDetailResponseModelToJson(MovieDetailResponseModel data) =>
